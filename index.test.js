...
// test fun need 2 things - str and callback function
test("test function", () => {
  expect(2).toBe(2);
});
...
describe("shortenBio tests"),
  () => {
    test("shortenBio will return a smaller Bio string", () => {
      ...
      // alt: // expect (shortBio.length).not.toBeGreaterThan(testData.bio.length)
    });
    ...
    // test returning hr min to check for length
    describe();
  }
*///